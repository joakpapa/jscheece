        ...
        a.initials = {
            ...
            dates: {
				...
				el: {
                        ...
                        noEventForThisDay: "Καμία εκδήλωση για αυτήν την ημέρα.. ξεκουραστείτε λοιπόν! :)",
                        previousYearText: "Προηγούμενο έτος",
                        nextYearText: "Επόμενο έτος",
                        closeSidebarText: "Κλείστε την πλαϊνή γραμμή",
                        closeEventListText: "Κλείστε τη λίστα συμβάντων"
                },
            }
        },
        a.initials.weekends = {
