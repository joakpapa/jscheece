        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mb-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="login-page.php">Λογαριασμός</a>
                    </li>
                    <li class="nav-item">
...
<h3 class="d-flex justify-content-center pt-5">
    <?php echo "Καλώς ήρθατε " . $_SESSION['customer_company'];?>
</h3>
<!--Αρχή εικόνας για αποσύνδεση-->
<a id="logoutLink" class="d-flex justify-content-center" href="procedures/logout.php"> </a>
    <br>
...
<div class="container-fluid d-flex justify-content-center">
    <div class="col-md-5 mb-5">
			...
			<form action="procedures/update_customer.php" method="post">
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="fname">Όνομα*</label>
						<input type="text" class="form-control" name="customer_fname" value="<?php echo $_SESSION['customer_fname'];?>" required>
					</div>
					<div class="col-md-6 mb-3">
						<label for="lname">Επώνυμο*</label>
						<input type="text" class="form-control" name="customer_lname" value="<?php echo $_SESSION['customer_lname'];?>" required>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 mb-3">
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" name="customer_phone" 
                            value="<?php echo $_SESSION['customer_phone'];?>" 
                        >
					</div>
					<div class="col-md-6 mb-3">
						<label for="company">Εταιρία:</label>
						<input type="text" class="form-control" name="customer_company" 
                            value="<?php echo $_SESSION['customer_company'];?>" required
                        >
					</div>
				</div>				
				<div class="row">
					<div class="col-md-12 mb-3">
						...
						<input type="text" class="form-control" name="customer_address"
                            value="<?php echo $_SESSION['customer_address']; ?>" required
                        >
					</div>
				</div>
                <!--Αρχή εικόνας Αποθήκευση και Διαγραφή-->				
				<div class="d-grid gap-2">
        <button id="saveBtn" class="btn btn-success" type="submit">
        </button>

        <a id="deleteLink" class="btn btn-danger" href="procedures/delete_customer.php">
        </a>
    </div>
    ...
    <script>
        ...
        deleteLink.appendChild(deleteIcon);
            ...
            <!--Τέλος εικόνας Αποθήκευση και Διαγραφή-->			
			</form>	
	</div> 
</div>
